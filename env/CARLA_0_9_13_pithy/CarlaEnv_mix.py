...
class CarlaEnv(object):
    ...
    def _init_blueprints(self):
        ...
        ### blinding
        # self.rgb_camera_bp.set_attribute('exposure_max_bright', '9.0')     # over-exposure
        # self.rgb_camera_bp.set_attribute('exposure_min_bright', '7.0')      # under-exposure
    
        ### normal
        # self.rgb_camera_bp.set_attribute('exposure_max_bright', '11.0')     # over-exposure
        # self.rgb_camera_bp.set_attribute('exposure_min_bright', '9.0')      # under-exposure

        ### midnight
        # self.rgb_camera_bp.set_attribute('exposure_max_bright', '15.0')     # over-exposure
        # self.rgb_camera_bp.set_attribute('exposure_min_bright', '11.0')      # under-exposure

        ### hardrain
        # self.rgb_camera_bp.set_attribute('exposure_max_bright', '13.0')     # over-exposure
        # self.rgb_camera_bp.set_attribute('exposure_min_bright', '11.0')      # under-exposure
        ...
        if self.selected_weather=="blinding":
            self.rgb_camera_bp.set_attribute('exposure_max_bright', '9.0')     # over-exposure
            self.rgb_camera_bp.set_attribute('exposure_min_bright', '7.0')      # under-exposure

            self.dvs_camera_bp.set_attribute('positive_threshold', str(0.1))#normal 0.1
            self.dvs_camera_bp.set_attribute('negative_threshold', str(0.1))
            self.dvs_camera_bp.set_attribute('sigma_positive_threshold', str(0.2))
            self.dvs_camera_bp.set_attribute('sigma_negative_threshold', str(0.2))

        elif self.selected_weather=="hard_rain":
        ...
        elif self.selected_weather=="normal":
            self.rgb_camera_bp.set_attribute('exposure_max_bright', '11.0')     # over-exposure
            self.rgb_camera_bp.set_attribute('exposure_min_bright', '9.0')      # under-exposure
            self.dvs_camera_bp.set_attribute('positive_threshold', str(0.1))#normal 0.1
            self.dvs_camera_bp.set_attribute('negative_threshold', str(0.1))
            ...
            self.rgb_camera_bp.set_attribute('exposure_max_bright', '15.0')     # over-exposure
            self.rgb_camera_bp.set_attribute('exposure_min_bright', '11.0')      # under-exposure
            self.dvs_camera_bp.set_attribute('positive_threshold', str(0.6))#normal 0.1
            self.dvs_camera_bp.set_attribute('negative_threshold', str(0.6))
            self.dvs_camera_bp.set_attribute('sigma_positive_threshold', str(0.2))
            self.dvs_camera_bp.set_attribute('sigma_negative_threshold', str(0.2))
        ### normal and blinding
        # self.dvs_camera_bp.set_attribute('positive_threshold', str(0.1))#normal 0.1
        ...
        ### hardrain
        # self.dvs_camera_bp.set_attribute('positive_threshold', str(0.3))#normal 0.1
        ...
        # self.lidar_camera_bp.set_attribute('points_per_second', '100000')
        ...
        self.lidar_camera_bp.set_attribute('rotation_frequency', '40')
        self.lidar_camera_bp.set_attribute('dropoff_general_rate',
                    self.lidar_camera_bp.get_attribute('dropoff_general_rate').recommended_values[0])
        self.lidar_camera_bp.set_attribute('dropoff_intensity_limit',
                    self.lidar_camera_bp.get_attribute('dropoff_intensity_limit').recommended_values[0])
    ...
    def reset_surrounding_vehicles(self):
        ...
        if self.selected_weather=="blinding":
            ...
            for one_type in ["same_dir_veh","same_dir_veh2", "oppo_dir_veh"]:
